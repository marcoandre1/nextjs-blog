...
function Home() {
  return __jsx("div", {
    ...
    rel: "icon",
    href: "".concat(publicRuntimeConfig.staticFolder, "/favicon.ico"),
    className: "jsx-1799183244",
    __self: this,
    __source: {
      fileName: _jsxFileName,
    ...
    src: "".concat(publicRuntimeConfig.staticFolder, "/vercel.svg"),
    alt: "Vercel Logo",
